...
<head>
    ...
    <title>administrative-management-system</title>
...
<body>
    ...
    <div class="main">
        ...
        <div class="login-container">
            ...
            <img src="laravel/public/assets/images/dashboard/rkive1.png" alt="" width="415" height="60" ;>
            ...
            <form action="./endpoint/add-user.php" method="POST">
                ...
                <div class="form-group registration row">
                    <div class="col-5">
                        ...
                        <input type="number" class="form-control" id="contactNumber" name="contact_number" maxlength="11" required="number only">
