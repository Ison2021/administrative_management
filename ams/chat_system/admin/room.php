<div class="col-lg-8">
            <div class="panel panel-default" style="height:50px; ">
				...
				<div class="showme hidden" style="position: absolute; left:-100px; top:20px;">
					<div class="well">
			...
			<div>
				...
				<div class="input-group">
					...
					<a href="http://localhost:8080/login-system-with-email-verification/email-sender-with-file-attachment/index.php" target="blank" data-toggle="modal" class="btn btn-primary">Send via Gmail</a>
