		<div class="col-lg-8">
			...
			<div>
				...
				<div class="input-group">
					...
					<a href="http://localhost:8080/login-system-with-email-verification/email-sender-with-file-attachment/index.php" target="_blank" data-toggle="modal" class="btn btn-primary">Send via Gmail</a>
